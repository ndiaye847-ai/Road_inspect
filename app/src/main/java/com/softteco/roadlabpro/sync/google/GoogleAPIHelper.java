...
public class GoogleAPIHelper implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
	...
	// Original Google OAuth credentials removed for security.
	// Create your own OAuth 2.0 client in Google Cloud Console and set these,
	// e.g. via BuildConfig fields sourced from local.properties / env vars.
	private static String CLIENT_ID = BuildConfig.GOOGLE_CLIENT_ID;

	private static String CLIENT_SECRET = BuildConfig.GOOGLE_CLIENT_SECRET;
