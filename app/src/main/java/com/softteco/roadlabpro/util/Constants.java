...
public class Constants {
    ...
    // Original hardcoded Dropbox access token removed for security (unused at runtime;
    // real per-user tokens are obtained via OAuth and stored through PreferencesUtil).
